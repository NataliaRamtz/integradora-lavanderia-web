...
export default function TicketsLavanderiaPage() {
      ...
      <div className="space-y-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Gestiona los tickets de soporte de tu lavandería.</p>
          </div>
          <Button onClick={() => router.push("/lavanderia/tickets/nuevo")}>
            ...
            <Card key={ticket.id}>
              ...
              <CardContent>
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="outline" onClick={() => router.push(`/lavanderia/tickets/${ticket.id}`)}>
                    Ver Detalles
                  </Button>
                </div>
              </CardContent>
